...
public class AwsSample {
	...
	public static void main(String[] args) throws Exception {
		...
		String securityGroup = "Test_JavaSecurityGroup"
		...
		try {
			 ...
			 * 
			 *********************************************/
			System.out.println("#5 Create a Key Pair");
			CreateKeyPairRequest createKeyPairRequest = new CreateKeyPairRequest();
			// createKeyPairRequest.setKeyName(keyName);
			String keyName = "Test_Sample.pem";
			...
			ipPermission4.withIpRanges("0.0.0.0/0").withIpProtocol("tcp")
					.withFromPort(65535).withToPort(65535);
			...
			/*********************************************
			 * 
			 * #10 Create a 'tag' for the new instance.
			 * 
			 *********************************************/
